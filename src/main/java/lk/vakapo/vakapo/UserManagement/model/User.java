...
public class User {
    ...
    /**
     * Alias accessor for contact number.
     *
     * <p>The feedback form expects a "phone" field. To keep backwards
     * compatibility with existing code, expose the user's contact number via
     * {@code getPhone()} and allow setting it via {@code setPhone(String)}.
     */
    ...
    /**
     * Alias mutator for contact number.
     *
     * <p>Sets the user's contact number. This is mapped to the {@link #contact}
     * field internally.
     *
