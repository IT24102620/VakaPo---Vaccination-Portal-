...
async function loadMyReviews() {
    try {
        const response = await fetch('/clinic/api/my-reviews');
...
async function deleteReview(feedbackId) {
    if (confirm('Are you sure you want to delete this review? This action cannot be undone.')) {
        try {
            ...
            const response = await fetch('/clinic/api/delete-review', {
                method: 'POST',
                body: formData
            });
...
document.getElementById('editReviewForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('/clinic/api/update-review', {
            method: 'POST',
            body: formData
        });
